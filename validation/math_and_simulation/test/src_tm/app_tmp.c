...
static const char *CompileLibs[] = {
    /* ../../../fake/win64/lib/../../../src_lib/Portings/win64/lib/libtruck.a */
    ...
    "libtruck.a	CarMaker-Truck win64 10.2.3 2022-11-14",
    "libcarmaker.a	CarMaker win64 10.2.3 2022-11-14",
    "libipgdriver.a	IPGDriver win64 10.2 2021-10-21",
    "libipgroad.a	IPGRoad win64 10.2.3 2022-11-11",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=100203",
    "-DMYMODELS -Wall -Wimplicit -Wmissing-prototypes",
    "-D__USE_MINGW_ANSI_STDIO -Wlogical-op",
    NULL
};


tAppStartInfo   AppStartInfo = {
    "TruckMaker 10.2.3 - Truck_Generic",          /* App_Version         */
    "2",          /* App_BuildVersion    */
    "jetbrains",     /* App_CompileUser     */
    "b979f2f8d573",         /* App_CompileSystem   */
    "2022-11-14 12:18:35",  /* App_CompileTime */
