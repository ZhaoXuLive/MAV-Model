function qdd_output = newton_vehicle_model(unit_n, axle_m, ..., 
    getNumUnit, m, Iz, Ca, lu, lg, la, q_input, qd_input, delta_input, V, sat)

% change V
psi1 = q_input(3);
xd_v = V;
yd_v = - qd_input(1) * sin(psi1) + qd_input(2) * cos(psi1);
