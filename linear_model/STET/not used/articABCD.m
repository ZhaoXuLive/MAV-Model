function [A,B,C,D]=articABCD(M,J,L,Ca,Xf,Xr,U)
...
% inputs: steer angles at each axle (N inputs)
% outputs: all states
%
...
n=length(M); %number of units
N=length(cell2mat(L)); %number of axles
