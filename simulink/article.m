...
% figure(2);
hold on;
title('Trajctory of All Axle','FontName','Times New Roman','FontSize',8);
xlabel('X (East) [m]','FontName','Times New Roman','FontSize',8);
ylabel('Y (North) [m]','FontName','Times New Roman','FontSize',8);
axis equal;
set(get(gca, 'Xlabel'),'FontName','Times New Roman','FontSize',8);
...
legend('Ref','Axle 1','Axle 3','Axle 4','Axle 5','Axle 6','Axle 8','FontName','Times New Roman','FontSize',8);%'Joint1','Joint2',

subplot(2,2,2)
% figure(3);
% plot(s,offtrack,'Linewidth', 2);
title('Offtrack of All Axle','FontName','Times New Roman','FontSize',8);
xlabel('S [m]','FontName','Times New Roman','FontSize',8);
ylabel('Offtrack [m]','FontName','Times New Roman','FontSize',8);
% xlim([0 120]);
% ylim([-0.05 0.05]);
set(get(gca, 'Xlabel'),'FontName','Times New Roman','FontSize',8);
set(get(gca, 'Ylabel'),'FontName','Times New Roman','FontSize',8);
...
legend('Axle 1','Axle 3','Axle 4','Axle 5','Axle 6','Axle 8','FontName','Times New Roman','FontSize',8);
...
set(get(gca, 'Xlabel'),'FontName','Times New Roman','FontSize',8);
set(get(gca, 'Ylabel'),'FontName','Times New Roman','FontSize',8);
title(['Yaw Rate of Three Unit, RWA = ',num2str(RWA_yawrate,6) ],'FontName','Times New Roman','FontSize',8);
xlabel('Time [s]','FontName','Times New Roman','FontSize',8);
ylabel('Yaw Rate  [rad/s]','FontName','Times New Roman','FontSize',8);
...
legend('Unit 1','Unit 2','Unit 3','FontName','Times New Roman','FontSize',8);
...
set(get(gca, 'Xlabel'),'FontName','Times New Roman','FontSize',8);
set(get(gca, 'Ylabel'),'FontName','Times New Roman','FontSize',8);
title(['Lateral Acceleration of 1&3 Unit, RWA = ',num2str(RWA_latAcc,6) ],'FontName','Times New Roman','FontSize',8);
xlabel('Time [s]','FontName','Times New Roman','FontSize',8);
ylabel('Lateral Acceleration [m/(s^2)]','FontName','Times New Roman','FontSize',8);
...
legend('First Unit','Third Unit','Joint 1','Joint 2','FontName','Times New Roman','FontSize',8);
