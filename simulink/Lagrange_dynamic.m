function qdd = Lagrange_dynamic(q, qd, Fx, delta)
...
Tau_tire = L_long1 * (Delta_c * Fx - Delta_s * Ca * (delta - beta1)) ...
         + L_long2 * (Delta_c * Fx - Delta_s * Ca * (delta - beta2)) ...
         + L_lat1 * (Delta_s * Fx + Delta_c * Ca * (delta - beta1)) ...
         + L_lat2 * (Delta_s * Fx + Delta_c * Ca * (delta - beta2));

qdd = inv(M) * (Tau_tire - C * qd - D * qd);